...
export function ProfileEditFitForm() {
  const { profileForm, onProfileSubmit } = useEditProfile();
  const {
    handleSubmit,
    control,
    register,
      ...
      <FieldSet className="bg-card w-full px-8 py-5">
        <FieldGroup>
            ...
            {watch("goal") === "OTHER" && (
              <>
                <Input
                  ...
                  {...register("goalOther")}
                />
                <FieldError errors={[{ message: errors.goalOther?.message }]} />
              </>
            )}
          </Field>
          ...
          <Field>
            ...
            <FieldDescription>
              Conte um pouco sobre você, seus interesses e objetivos de fitness.
